...
export const copy = {
 es: {
  essence:'Un festival de música electrónica con raíces en Playa Venao.', festivalLabel:'EL FESTIVAL', dates:'19–20 de febrero de 2027', location:'Playa Venao, Panamá',
 ...
 en: {
  essence:'An electronic music festival rooted in Playa Venao.', festivalLabel:'THE FESTIVAL', dates:'February 19–20, 2027', location:'Playa Venao, Panama',
